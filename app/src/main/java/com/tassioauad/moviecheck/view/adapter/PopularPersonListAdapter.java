...
public class PopularPersonListAdapter extends RecyclerView.Adapter<PopularPersonListAdapter.ViewHolder> implements View.OnClickListener {

    private List<Person> personList;
    private OnItemClickListener<Person> personOnItemClickListener;

    public PopularPersonListAdapter(List<Person> personList, OnItemClickListener<Person> personOnItemClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.listviewitem_popularperson, parent, false);
    ...
    public void onClick(View v) {
        ...
        personOnItemClickListener.onClick(person, v);
    }
